...
class disciple_tools_user_activity_report_Endpoints
{
    /**
    ...
    public function add_api_routes() {
        $namespace = 'disciple_tools_user_activity_report/v1';
...
disciple_tools_user_activity_report_Endpoints::instance();
