...
class disciple_tools_user_activity_report_Site_Links {
    public $type = 'disciple_tools_user_activity_report';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'User Activity Report' );
        return $type;
    }
}
disciple_tools_user_activity_report_Site_Links::instance();
